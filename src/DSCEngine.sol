 ...
 * At no point, should the value of all collateral <= dollar backed value of all the DSC
 *
...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param amountCollateral The amount of collateral to deppsit
     ...
     * @notice A known bug would be if the protocol were 100% or less collaterized, then we wouldn't be able to incentivize the liquidators.
